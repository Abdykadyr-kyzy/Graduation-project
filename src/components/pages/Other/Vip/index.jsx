            ...
            <div style={{display:'flex',flexDirection:'column',justifyContent:'center',textAlign:'center'}}>
                ...
                <h2>Предлагаем Вам услуги VIP и Бизнес залов</h2>
                    <Carousel effect="fade">
                        <div>
                            <img style={{width:300,height:200,textAlign:'center',alignItems:'center'}} src="https://vip-zal.ru/uploads/431/289dbf165b-manas-9.jpg" alt="" />
                        </div>
                        <div>
                            <img style={{width:300,height:200}} src="https://glavtour.kg/wp-content/uploads/2017/06/vip.png" alt="" />
                        </div>
                        <div>
                            <img styl={{width:300,height:200}} src="https://airfresh.kg/templates/g5_helium/custom/images/viplounge/manas1.png" alt=""  />
                        </div>
                    </Carousel>
